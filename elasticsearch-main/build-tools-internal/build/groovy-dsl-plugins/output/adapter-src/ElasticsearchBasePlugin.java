...
/**
 * Precompiled elasticsearch.base script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class ElasticsearchBasePlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ElasticsearchBase").asSubclass(BasicScript.class);
