...
/**
 * Precompiled elasticsearch.bc-upgrade-test script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class ElasticsearchBcUpgradeTestPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ElasticsearchBcUpgradeTest").asSubclass(BasicScript.class);
