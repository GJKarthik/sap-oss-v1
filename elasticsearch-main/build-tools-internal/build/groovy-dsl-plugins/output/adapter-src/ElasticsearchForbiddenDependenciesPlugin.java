...
/**
 * Precompiled elasticsearch.forbidden-dependencies script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class ElasticsearchForbiddenDependenciesPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ElasticsearchForbiddenDependencies").asSubclass(BasicScript.class);
