...
/**
 * Precompiled elasticsearch.authenticated-testclusters script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class ElasticsearchAuthenticatedTestclustersPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ElasticsearchAuthenticatedTestclusters").asSubclass(BasicScript.class);
  ...
  private static void assertSupportedByCurrentGradleVersion() {
      if (GradleVersion.current().getBaseVersion().compareTo(GradleVersion.version(MIN_SUPPORTED_GRADLE_VERSION)) < 0) {
          throw new RuntimeException("Precompiled Groovy script plugins built by Gradle 9.3.1 require Gradle "+MIN_SUPPORTED_GRADLE_VERSION+" or higher");
      }
  }
}
//CHECKSTYLE:ON
