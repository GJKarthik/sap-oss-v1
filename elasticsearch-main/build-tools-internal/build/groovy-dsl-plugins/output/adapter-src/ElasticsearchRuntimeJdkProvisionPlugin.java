...
/**
 * Precompiled elasticsearch.runtime-jdk-provision script plugin.
 **/
@SuppressWarnings("DefaultPackage")
public class ElasticsearchRuntimeJdkProvisionPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ElasticsearchRuntimeJdkProvision").asSubclass(BasicScript.class);
