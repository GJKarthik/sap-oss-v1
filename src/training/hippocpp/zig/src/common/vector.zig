...
test "int64 vector" {
    ...
    try vec.append(std.testing.allocator, 100);
    try vec.append(std.testing.allocator, 200);
    try vec.appendNull();
    try vec.append(std.testing.allocator, 300);
...
test "int64 vector sum" {
    ...
    try vec.append(std.testing.allocator, 10);
    try vec.append(std.testing.allocator, 20);
    try vec.append(std.testing.allocator, 30);
...
test "float64 vector" {
    ...
    try vec.append(std.testing.allocator, 1.5);
    try vec.append(std.testing.allocator, 2.5);
...
test "bool vector" {
    ...
    try vec.append(std.testing.allocator, true);
    try vec.append(std.testing.allocator, false);
    try vec.append(std.testing.allocator, true);
