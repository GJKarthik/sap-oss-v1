...
pub const Transaction = struct {
    ...
    pub fn addModifiedTable(self: *Self, table_id: TableID) !void {
        ...
        try self.modified_tables.append(self.allocator, table_id);
    }
    
    pub fn deinit(self: *Self) void {
        self.modified_tables.deinit(self.allocator);
    }
};
...
pub const TransactionManager = struct {
    ...
    pub fn beginTransaction(self: *Self, tx_type: TransactionType) !*Transaction {
        ...
        try self.active_transactions.append(self.allocator, tx);
        return tx;
    }
    ...
    pub fn destroy(self: *Self) void {
        ...
        self.active_transactions.deinit(self.allocator);
