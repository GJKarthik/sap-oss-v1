...
pub const StructChunkData = struct {
    ...
    pub fn deinit(self: *Self) void {
        ...
        self.struct_null_mask.deinit(self.allocator);
    }
    ...
    pub fn addField(self: *Self, name: []const u8, data_type: LogicalType) !u32 {
        ...
        try self.field_names.append(self.allocator, name);
        try self.children.append(self.allocator, ChildChunkData.init(self.allocator, field);
    ...
    pub fn appendStruct(self: *Self, is_null: bool) !void {
        try self.struct_null_mask.append(self.allocator, is_null);
        self.num_values += 1;
    }
...
pub const StructColumn = struct {
    ...
    pub fn deinit(self: *Self) void {
        ...
        self.field_definitions.deinit(self.allocator);
    }
    ...
    pub fn defineField(self: *Self, name: []const u8, data_type: LogicalType) !void {
        ...
        try self.field_definitions.append(self.allocator, StructField.init(name, data_type, idx);
    }
