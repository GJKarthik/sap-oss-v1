...
test "expression factory literals" {
    ...
    defer int_expr.deinit(std.testing.allocator);
...
test "expression factory column" {
    ...
    defer col_expr.deinit(std.testing.allocator);
...
test "expression comparison" {
    ...
    defer cmp.deinit(std.testing.allocator);
