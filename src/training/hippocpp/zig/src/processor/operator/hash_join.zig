...
pub const BuildSideInfo = struct {
    ...
    pub fn deinit(self: *BuildSideInfo) void {
        self.payload_col_indices.deinit(self.allocator);
    }
};
...
pub const HashJoinOperator = struct {
    ...
    pub fn destroy(self: *Self) void {
        ...
        self.build_info.deinit(self.allocator);
        self.probe_info.deinit(self.allocator);
    ...
    fn buildHashTable(self: *Self) !void {
        ...
        defer input_chunk.deinit(self.allocator);
    ...
    fn probeHashTable(self: *Self, chunk: *DataChunk) !ResultState {
        ...
        defer probe_chunk.deinit(self.allocator);
