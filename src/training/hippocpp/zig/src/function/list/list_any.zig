//! function/list/list_any parity module.
...
pub fn modulePath() []const u8 {
    return "function/list/list_any";
}

test "list_any module path" {
    try std.testing.expectEqualStrings("function/list/list_any", modulePath());
}

test "list_any canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/list/list_any"));
}
