//! function/list/list_reduce parity module.
...
pub fn modulePath() []const u8 {
    return "function/list/list_reduce";
}

test "list_reduce module path" {
    try std.testing.expectEqualStrings("function/list/list_reduce", modulePath());
}

test "list_reduce canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/list/list_reduce"));
}
