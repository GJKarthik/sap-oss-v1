//! function/list/list_none parity module.
...
pub fn modulePath() []const u8 {
    return "function/list/list_none";
}

test "list_none module path" {
    try std.testing.expectEqualStrings("function/list/list_none", modulePath());
}

test "list_none canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/list/list_none"));
}
