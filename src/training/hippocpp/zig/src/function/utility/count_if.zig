//! function/utility/count_if parity module.
...
pub fn modulePath() []const u8 {
    return "function/utility/count_if";
}

test "count_if module path" {
    try std.testing.expectEqualStrings("function/utility/count_if", modulePath());
}

test "count_if canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/utility/count_if"));
}
