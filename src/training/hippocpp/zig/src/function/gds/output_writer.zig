//! function/gds/output_writer parity module.
...
pub fn modulePath() []const u8 {
    return "function/gds/output_writer";
}

test "output_writer module path" {
    try std.testing.expectEqualStrings("function/gds/output_writer", modulePath());
}

test "output_writer canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/gds/output_writer"));
}
