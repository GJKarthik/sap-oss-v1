//! function/gds/ssp_paths parity module.
...
pub fn modulePath() []const u8 {
    return "function/gds/ssp_paths";
}

test "ssp_paths module path" {
    try std.testing.expectEqualStrings("function/gds/ssp_paths", modulePath());
}

test "ssp_paths canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/gds/ssp_paths"));
}
