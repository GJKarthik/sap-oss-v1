...
export class AppComponent {
  ...
  constructor() {
    // sessionStorage scopes the key to this tab and clears on tab close
    this.apiKey = sessionStorage.getItem('modelopt_api_key') || '';
  }
  ...
  saveApiKey(): void {
    sessionStorage.setItem('modelopt_api_key', this.apiKey);
    alert('API Key saved');
  }
}