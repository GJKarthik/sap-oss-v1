...
pub const TableSchema = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, table_id: u64, name: []const u8, table_type: TableType) TableSchema {
        return .{
            ...
            .primary_key_columns = std.ArrayList(u32).init(allocator),
    ...
    pub fn deinit(self: *TableSchema) void {
        self.columns.deinit();
        self.primary_key_columns.deinit();
    ...
    pub fn setPrimaryKey(self: *TableSchema, column_ids: []const u32) !void {
        ...
        try self.primary_key_columns.appendSlice(column_ids);
    }
};
...
pub const Catalog = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) Catalog {
        return .{
            .allocator = allocator,
            .entries = std.ArrayList(CatalogEntry).init(allocator),
    ...
    /// Get all table names
    pub fn getTableNames(self: *const Catalog, allocator: std.mem.Allocator) ![][]const u8 {
