//! common/types/value/value parity module.
...
pub fn modulePath() []const u8 {
    return "common/types/value/value";
}

test "value module path" {
    try std.testing.expectEqualStrings("common/types/value/value", modulePath());
}

test "value resolved tag fallback" {
    var node = ParityNode.init("");
    try std.testing.expect(node.tagMatches("common/types/value/value"));
}
