//! planner/join_order/join_order_util parity module.
...
pub fn plannerPath() []const u8 {
    return "planner/join_order/join_order_util";
}

test "join_order_util planner path" {
    try std.testing.expectEqualStrings("planner/join_order/join_order_util", plannerPath());
}

test "join_order_util planner id fallback" {
    var stage = PlannerStage.init("");
    try std.testing.expect(stage.idMatches("planner/join_order/join_order_util"));
}
