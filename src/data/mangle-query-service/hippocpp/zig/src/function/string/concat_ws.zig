//! function/string/concat_ws parity module.
...
pub fn modulePath() []const u8 {
    return "function/string/concat_ws";
}

test "concat_ws module path" {
    try std.testing.expectEqualStrings("function/string/concat_ws", modulePath());
}

test "concat_ws canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/string/concat_ws"));
}
