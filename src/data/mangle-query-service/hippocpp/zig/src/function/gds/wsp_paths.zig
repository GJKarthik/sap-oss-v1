//! function/gds/wsp_paths parity module.
...
pub fn modulePath() []const u8 {
    return "function/gds/wsp_paths";
}

test "wsp_paths module path" {
    try std.testing.expectEqualStrings("function/gds/wsp_paths", modulePath());
}

test "wsp_paths canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/gds/wsp_paths"));
}
