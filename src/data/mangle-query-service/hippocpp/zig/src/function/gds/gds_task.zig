//! function/gds/gds_task parity module.
...
pub fn modulePath() []const u8 {
    return "function/gds/gds_task";
}

test "gds_task module path" {
    try std.testing.expectEqualStrings("function/gds/gds_task", modulePath());
}

test "gds_task canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/gds/gds_task"));
}
