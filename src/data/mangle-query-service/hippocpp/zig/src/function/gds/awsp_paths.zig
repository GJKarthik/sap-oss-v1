//! function/gds/awsp_paths parity module.
...
pub fn modulePath() []const u8 {
    return "function/gds/awsp_paths";
}

test "awsp_paths module path" {
    try std.testing.expectEqualStrings("function/gds/awsp_paths", modulePath());
}

test "awsp_paths canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/gds/awsp_paths"));
}
