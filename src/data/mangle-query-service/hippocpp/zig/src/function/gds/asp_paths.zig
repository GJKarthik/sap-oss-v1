//! function/gds/asp_paths parity module.
...
pub fn modulePath() []const u8 {
    return "function/gds/asp_paths";
}

test "asp_paths module path" {
    try std.testing.expectEqualStrings("function/gds/asp_paths", modulePath());
}

test "asp_paths canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/gds/asp_paths"));
}
