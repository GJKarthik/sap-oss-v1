//! function/gds/gds_utils parity module.
...
pub fn modulePath() []const u8 {
    return "function/gds/gds_utils";
}

test "gds_utils module path" {
    try std.testing.expectEqualStrings("function/gds/gds_utils", modulePath());
}

test "gds_utils canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/gds/gds_utils"));
}
