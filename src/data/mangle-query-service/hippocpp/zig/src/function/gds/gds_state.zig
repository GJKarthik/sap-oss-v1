//! function/gds/gds_state parity module.
...
pub fn modulePath() []const u8 {
    return "function/gds/gds_state";
}

test "gds_state module path" {
    try std.testing.expectEqualStrings("function/gds/gds_state", modulePath());
}

test "gds_state canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/gds/gds_state"));
}
