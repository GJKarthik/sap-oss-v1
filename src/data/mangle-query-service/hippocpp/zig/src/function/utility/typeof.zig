//! function/utility/typeof parity module.
...
pub fn modulePath() []const u8 {
    return "function/utility/typeof";
}

test "typeof module path" {
    try std.testing.expectEqualStrings("function/utility/typeof", modulePath());
}

test "typeof canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/utility/typeof"));
}
