//! function/table/show_macros parity module.
...
pub fn modulePath() []const u8 {
    return "function/table/show_macros";
}

test "show_macros module path" {
    try std.testing.expectEqualStrings("function/table/show_macros", modulePath());
}

test "show_macros canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/table/show_macros"));
}
