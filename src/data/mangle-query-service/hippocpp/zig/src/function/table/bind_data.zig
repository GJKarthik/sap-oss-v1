//! function/table/bind_data parity module.
...
pub fn modulePath() []const u8 {
    return "function/table/bind_data";
}

test "bind_data module path" {
    try std.testing.expectEqualStrings("function/table/bind_data", modulePath());
}

test "bind_data canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/table/bind_data"));
}
