//! function/table/bind_input parity module.
...
pub fn modulePath() []const u8 {
    return "function/table/bind_input";
}

test "bind_input module path" {
    try std.testing.expectEqualStrings("function/table/bind_input", modulePath());
}

test "bind_input canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/table/bind_input"));
}
