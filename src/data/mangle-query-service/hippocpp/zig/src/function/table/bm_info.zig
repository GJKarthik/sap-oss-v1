//! function/table/bm_info parity module.
...
pub fn modulePath() []const u8 {
    return "function/table/bm_info";
}

test "bm_info module path" {
    try std.testing.expectEqualStrings("function/table/bm_info", modulePath());
}

test "bm_info canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/table/bm_info"));
}
