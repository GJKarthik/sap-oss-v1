//! function/arithmetic/negate parity module.
...
pub fn modulePath() []const u8 {
    return "function/arithmetic/negate";
}

test "negate module path" {
    try std.testing.expectEqualStrings("function/arithmetic/negate", modulePath());
}

test "negate canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/arithmetic/negate"));
}
