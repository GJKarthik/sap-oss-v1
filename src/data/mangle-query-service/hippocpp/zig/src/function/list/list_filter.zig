//! function/list/list_filter parity module.
...
pub fn modulePath() []const u8 {
    return "function/list/list_filter";
}

test "list_filter module path" {
    try std.testing.expectEqualStrings("function/list/list_filter", modulePath());
}

test "list_filter canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/list/list_filter"));
}
