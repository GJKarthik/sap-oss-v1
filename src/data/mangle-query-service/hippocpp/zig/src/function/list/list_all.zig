//! function/list/list_all parity module.
...
pub fn modulePath() []const u8 {
    return "function/list/list_all";
}

test "list_all module path" {
    try std.testing.expectEqualStrings("function/list/list_all", modulePath());
}

test "list_all canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/list/list_all"));
}
