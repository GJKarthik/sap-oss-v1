//! function/list/list_single parity module.
...
pub fn modulePath() []const u8 {
    return "function/list/list_single";
}

test "list_single module path" {
    try std.testing.expectEqualStrings("function/list/list_single", modulePath());
}

test "list_single canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/list/list_single"));
}
