//! function/array/array_value parity module.
...
pub fn modulePath() []const u8 {
    return "function/array/array_value";
}

test "array_value module path" {
    try std.testing.expectEqualStrings("function/array/array_value", modulePath());
}

test "array_value canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/array/array_value"));
}
