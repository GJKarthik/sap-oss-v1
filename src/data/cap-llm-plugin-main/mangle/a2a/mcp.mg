...
# Graph-RAG: embedded KùzuDB service/deployment/table relationship graph
service_registry("cap-llm-graph",  "http://localhost:9100/mcp",  "graph-rag").
...
resolve_service_for_intent(/graph_index, URL) :-
    service_registry("cap-llm-graph", URL, _).
...
tool_service("kuzu_index",    "cap-llm-graph").
tool_service("kuzu_query",    "cap-llm-graph").