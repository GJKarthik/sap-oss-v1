...
pub const DartHeadHandle = ?*anyopaque;
pub const struct_DartHeadConfigFFI = extern struct {
    hidden_size: i32 = @import("std").mem.zeroes(i32),
    vocab_size: i32 = @import("std").mem.zeroes(i32),
    num_draft_positions: i32 = @import("std").mem.zeroes(i32),
    head_hidden_size: i32 = @import("std").mem.zeroes(i32),
    num_heads: i32 = @import("std").mem.zeroes(i32),
    ffn_multiplier_x100: i32 = @import("std").mem.zeroes(i32),
    use_int8: i32 = @import("std").mem.zeroes(i32),
    _padding: i32 = @import("std").mem.zeroes(i32),
};
pub const DartHeadConfigFFI = struct_DartHeadConfigFFI;
pub extern fn dart_head_create(config: [*c]const DartHeadConfigFFI) DartHeadHandle;
pub extern fn dart_head_destroy(handle: DartHeadHandle) void;
pub extern fn dart_head_forward(handle: DartHeadHandle, hidden_states: ?*const anyopaque, batch_size: i32, prefix_len: i32, output_logits: ?*anyopaque) i32;
pub extern fn dart_head_get_top_k(handle: DartHeadHandle, logits: ?*const anyopaque, batch_size: i32, K: i32, n_candidates: i32, out_ids: [*c]u32, out_log_probs: [*c]f32) i32;
pub extern fn dart_head_get_config(handle: DartHeadHandle, out_config: [*c]DartHeadConfigFFI) i32;
pub extern fn dart_head_memory_usage_mb(handle: DartHeadHandle) f32;
pub extern fn dart_head_load_weights(handle: DartHeadHandle, weight_data: [*c]const u8, data_size: i64) i32;
pub fn dart_config_llama_8b() callconv(.c) DartHeadConfigFFI {
    var config: DartHeadConfigFFI = DartHeadConfigFFI{
        .hidden_size = @as(c_int, 4096),
        .vocab_size = @as(c_int, 128256),
        .num_draft_positions = @as(c_int, 4),
        .head_hidden_size = @as(c_int, 512),
        .num_heads = @as(c_int, 8),
        .ffn_multiplier_x100 = @as(c_int, 200),
        .use_int8 = @as(c_int, 1),
        ._padding = @as(c_int, 0),
    };
    _ = &config;
...
pub fn dart_config_qwen_7b() callconv(.c) DartHeadConfigFFI {
    var config: DartHeadConfigFFI = DartHeadConfigFFI{
        .hidden_size = @as(c_int, 3584),
        .vocab_size = @as(c_int, 152064),
        .num_draft_positions = @as(c_int, 4),
        .head_hidden_size = @as(c_int, 512),
        .num_heads = @as(c_int, 8),
        .ffn_multiplier_x100 = @as(c_int, 200),
...
pub fn dart_config_default() callconv(.c) DartHeadConfigFFI {
    var config: DartHeadConfigFFI = DartHeadConfigFFI{
        .hidden_size = @as(c_int, 4096),
        .vocab_size = @as(c_int, 32000),
        .num_draft_positions = @as(c_int, 4),
        .head_hidden_size = @as(c_int, 512),
        .num_heads = @as(c_int, 8),
        .ffn_multiplier_x100 = @as(c_int, 200),
