...
// Re-export tensor-level matrix operations (allocating + pre-allocated variants)
pub const tensorMatmul = tensor.matmul;
pub const tensorMatmulInto = tensor.matmulInto;
pub const tensorMatvec = tensor.matvec;
pub const tensorMatvecInto = tensor.matvecInto;
