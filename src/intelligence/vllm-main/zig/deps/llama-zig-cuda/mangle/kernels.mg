...
kernel_impl("rms_norm", "scalar", "loop").
kernel_impl("rms_norm", "avx2", "vectorized_256").
kernel_impl("rms_norm", "neon", "vectorized_128").

kernel_impl("softmax", "scalar", "loop").
kernel_impl("softmax", "avx2", "vectorized_256").

kernel_impl("rope", "scalar", "loop_sincos").
kernel_impl("rope", "avx2", "precomputed_table").
kernel_impl("rope", "neon", "precomputed_table").

kernel_impl("dequant_q4k", "scalar", "loop_nibble").
kernel_impl("dequant_q4k", "avx2", "simd_nibble_unpack").

kernel_impl("dequant_q8k", "scalar", "loop_scale").
kernel_impl("dequant_q8k", "avx2", "simd_scale_256").
