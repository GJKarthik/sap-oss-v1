...
/**
 * RTL (Arabic) visual regression tests for UI5 Playground.
...
/**
 * Switch the UI5 Playground to Arabic via the `ui5-language` localStorage key.
 */
...
test.describe('UI5 Playground RTL Visual Regression', () => {
