...
`@ui5/webcomponents-ngx` supports all the themes, that are available in `@ui5/webcomponents` library, you can check the list [here](https://sap.github.io/ui5-webcomponents/docs/advanced/configuration/)
