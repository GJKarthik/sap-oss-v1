/**
 * Locale-aware formatting pipes for the Playground app.
 *
...
export class PlaygroundLocaleNumberPipe implements PipeTransform {
...
export class PlaygroundLocaleCurrencyPipe implements PipeTransform {
  private readonly i18n = inject(I18nService);
...
export class PlaygroundLocalePercentPipe implements PipeTransform {
  private readonly i18n = inject(I18nService);
