  ...
  template: `
    <section class="generative-page">
      <div class="generative-hero">
        ...
        <p>{{ 'GENERATIVE_PAGE_SUBTITLE' | ui5I18n }}</p>
      </div>
      ...
      <div class="generative-grid">
        <ui5-card class="generative-card">
          <ui5-card-header
            slot="header"
            [attr.title-text]="'GENERATIVE_COMPOSER_TITLE' | ui5I18n"
            [attr.subtitle-text]="'GENERATIVE_COMPOSER_DESC' | ui5I18n">
          </ui5-card-header>
          <div class="generative-card__body generative-card__body--composer">
            ...
            <div class="generative-suggestions">
              <span class="generative-suggestions__title">{{ 'GENERATIVE_SUGGESTIONS_TITLE' | ui5I18n }}</span>
