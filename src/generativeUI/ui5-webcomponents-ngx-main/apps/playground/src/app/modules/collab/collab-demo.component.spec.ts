...
/**
 * CollabDemoComponent unit tests
 *
 * Covers:
...
function createComponent() {
  ...
  const cdr = makeCdr();
  const component = new CollabDemoComponent(collab as never, cdr);
...
describe('CollabDemoComponent — initial state', () => {
...
describe('CollabDemoComponent — subscriptions', () => {
...
describe('CollabDemoComponent — actions', () => {
...
describe('CollabDemoComponent — getCursorColor', () => {
