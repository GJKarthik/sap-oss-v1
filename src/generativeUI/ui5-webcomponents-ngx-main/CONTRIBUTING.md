# Contributing to UI5 Web Components for Angular

We're excited that you're interested in contributing to UI5 Web Components for Angular! Your contribution can make this library even better.
...
If you find a bug or some other issue with any part of the library, please [submit an issue](https://github.com/SAP/ui5-webcomponents-ngx/issues). Before doing so, please make sure that:
...
If you meet the above criteria, you can submit issues with our [GitHub issue tracker](https://github.com/SAP/ui5-webcomponents-ngx/issues/new). Please use [labels](#usage-of-labels) to categorize your issue.
...
You are welcome to contribute code to UI5 Web Components for Angular in order to fix issues or to add new features.
...
2.  You must follow **code style, quality, and product standards requirements**. You can find more information [HERE](https://github.com/SAP/ui5-webcomponents-ngx/wiki/Code-Contribution-Guideline).
...
1. Search [GitHub](https://github.com/SAP/ui5-webcomponents-ngx/pulls) for an open or closed PR
   that relates to your submission. You don't want to duplicate effort.
1. Be sure that an issue describes the problem you're fixing, or documents the design for the feature you'd like to add.
   Discussing the design up front helps to ensure that we're ready to accept your work.
1. Fork the ui5-webcomponents-ngx repo.
...
Full description of current CI PipeLine can be found [here](<https://github.com/SAP/ui5-webcomponents-ngx/wiki/Deploy-(Release-and-Pre-Release)-pipe-line-description>).
...
-   Rules are also mentioned in our [Code Contribution Guideline](https://github.com/SAP/ui5-webcomponents-ngx/wiki/Code-Contribution-Guideline)
