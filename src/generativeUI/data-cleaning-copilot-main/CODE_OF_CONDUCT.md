...
This Code of Conduct applies to SAP's open source projects hosted on [github.com/SAP](https://github.com/SAP) and [github.com/SAP-samples](https://github.com/SAP-samples).
...
4. If there were other witnesses, please include them as well
...
2. Review the incident and determine appropriate action
3. Follow up with the reporter to inform them of the outcome
4. Take action as necessary

### Possible Responses

Depending on the severity and nature of the incident, responses may include:

- A private conversation with the individual(s) involved
...
- Value diverse opinions, viewpoints, and experiences
...
- Focus on technical merit and constructive discussion
...
*This Code of Conduct is maintained by SAP SE and applies to all SAP open source projects.*