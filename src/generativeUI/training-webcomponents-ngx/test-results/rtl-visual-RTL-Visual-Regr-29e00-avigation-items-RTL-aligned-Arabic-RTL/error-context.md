...
- Name: rtl-visual.spec.ts >> RTL Visual Regression Tests >> Shell Sidebar >> sidebar navigation items RTL-aligned
- Location: apps/angular-shell-e2e/src/rtl-visual.spec.ts:133:9
...
Timeout: 5000ms
  ...
  Snapshot: rtl-sidebar.png

Call log:
  - Expect "toHaveScreenshot(rtl-sidebar.png)" with timeout 5000ms
              ...
              - table "تفاصيل GPU" [ref=e216]:
                - rowgroup [ref=e217]:
                  ...
                  - row "درجة الحرارة 40 °C" [ref=e227]:
                    ...
                    - cell "40 °C" [ref=e229]
                  - row "الذاكرة المتاحة 3.3 GB" [ref=e230]:
                    - rowheader "الذاكرة المتاحة" [ref=e231]
                    - cell "3.3 GB" [ref=e232]
            - generic [ref=e233]:
...
```ts
  ...
  38  | // ─── Setup ────────────────────────────────────────────────────────────────────
  39  | 
  40  | test.describe('RTL Visual Regression Tests', () => {
  41  |   test.beforeEach(async ({ page }) => {
  42  |     await enableArabicRtl(page);
  43  |     await page.goto('/', { waitUntil: 'networkidle' });
