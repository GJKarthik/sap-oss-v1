...
if USE_FASTAPI:
    app = FastAPI(
        title="SAP OpenAI-Compatible Server (LangChain HANA)",
    ...
    def health():
        ...
        return {
            "status": "healthy",
            "service": "sap-openai-server-langchain-hana",
            "hana": hana_status
        }
...
def main():
    ...
    parser = argparse.ArgumentParser(description="SAP OpenAI-Compatible Server (LangChain HANA)")
...
╔══════════════════════════════════════════════════════════╗
║                                                          ║
║   SAP OpenAI-Compatible Server (LangChain HANA)        ║
