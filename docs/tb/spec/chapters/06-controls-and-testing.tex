...
\begin{description}
  ...
  \item[EUC evidencing.] For each of \texttt{EUC-001}, \texttt{EUC-002},
        \texttt{EUC-003}, the evidence folder on Shared Drive must
        contain the rule-firing log and the reviewer signature. The
        quarterly ACG sampling exercise consumes this folder directly.
\end{description}
