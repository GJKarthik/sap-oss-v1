...
\begin{lstlisting}[language=yaml,caption=CI/CD enforcement configuration]
on:
  pull_request:
...
\begin{lstlisting}[language=yaml,caption=Example traceability mapping]
domains:
  simula:
...
\begin{lstlisting}[language=yaml,caption=Drift exception format]
exceptions:
  - id: "EXC-001"
    created: "2026-04-21"
