...
\path{docs/schema/common/enums.yaml} for controlled vocabulary.
...
\bottomrule
\end{tabularx}
\caption{Schemas under \texttt{docs/schema/regulations/}.}
\label{tab:schemas}
\end{table}
...
implementation and verification arrays (excerpt).},label={lst:req-example}]
{
  ...
  "source": {
    "regulationId": "imda-mgf-agentic-ai-v1",
    "section": "2.1.2",
    "page": 11,
...
\texttt{docs/regulations/machine-readable/specification-addendum.yaml} (\texttt{conformance-tools.aiverify}).}]
{
  "toolId": "aiverify",
...
\path{docs/schema/common/enums.yaml} centralises the controlled vocabularies
