...
\texttt{docs/schema/regulations/} as the JSON Schema artefacts consumed at
...
instruction schemas under \texttt{docs/schema/regulations/} and registers
...
\texttt{requirement.schema.json} under \texttt{docs/schema/regulations/}.
...
identity and audit-event schemas under \texttt{docs/schema/regulations/};
