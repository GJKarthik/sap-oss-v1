...
\begin{enumerate}
  \item \textbf{Make the regulations machine-readable.} Every source document
        ...
        \path{docs/regulations/machine-readable/} that capture sections, normative requirements,
  ...
  \item \textbf{Bind each requirement to evidence in the repository.} The
        ...
        (\path{docs/schema/validate.py}) fails when any of these paths no
        longer resolve.
...
\tool{python3 docs/schema/validate.py --registry-check} checks schema
