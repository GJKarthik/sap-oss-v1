...
\subsubsection{Elo Rating Algorithm}
...
\subsection{Adaptive Features (v1.2)}

\subsubsection{Adaptive Complexity Ratio (Figure 7)}
...
\subsubsection{Adaptive Critic Thresholding (Figure 3b)}
...
\subsubsection{Automatic Coverage Gap Filling}
...
\subsubsection{Diversity Optimizer}
...
\subsubsection{Taxonomy Quality Gate (Section B.1, Table 2)}
...
% =============================================================================
\newpage
\section*{Worked Example: Trial Balance Domain}
...
\subsection*{Step 1: Schema Extraction}
...
\subsection*{Step 2: Factor Identification}
...
\subsection*{Step 3: Taxonomy Generation}
...
\subsection*{Step 4: Mix Sampling and Meta-Prompt Generation}
...
\subsection*{Step 5: Example Generation}
...
\subsection*{Step 6: Evaluation Metrics}
...
\subsection*{Step 7: Output Files}
