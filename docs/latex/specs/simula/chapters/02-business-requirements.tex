...
\begin{itemize}
  ...
  \item \textbf{Chapter~\ref{chap:implementation-roadmap}} (Implementation Roadmap):
    BR-3.x quality requirements are addressed by the closed-loop validation
    capabilities in Phase~2; BR-4.x governance requirements by the workflow
    engine capabilities in Phase~3.
