...
\filepath{src/data/sap-ai-fabric-console/apps/angular-shell/src/app/services/mcp.service.ts}.
...
\filepath{src/data/sap-ai-fabric-console/apps/angular-shell/src/environments/}:
