...
The Python backend resides in \texttt{src/generativeUI/training-console/}.
...
\texttt{training-console/agent/data\_cleaning\_agent.py} & \ref{sec:python} \\
\texttt{training-console/bin/api.py} & \ref{sec:python} \\
