...
The Python backend resides in \texttt{src/generativeUI/data-cleaning-copilot-main/}.
...
\texttt{data-cleaning-copilot-main/agent/data\_cleaning\_agent.py} & \ref{sec:python} \\
\texttt{data-cleaning-copilot-main/bin/api.py} & \ref{sec:python} \\
