...
**Service used for audit:** **Data Cleaning Copilot** (`training-webcomponents-ngx`)  
**Date:** 2026-02-28
...
| **Where it lives in the repo** | Path: `src/generativeUI/training-webcomponents-ngx`. |
...
- **Commits listed:** The lineage section lists every commit that modified the service path (`src/generativeUI/training-webcomponents-ngx`), as produced by:
  ```bash
  git log --follow -- src/generativeUI/training-webcomponents-ngx
  ```
