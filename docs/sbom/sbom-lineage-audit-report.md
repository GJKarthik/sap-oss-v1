...
**Service used for audit:** **Data Cleaning Copilot** (`data-cleaning-copilot-main`)  
**Date:** 2026-02-28
...
| **Where it lives in the repo** | Path: `data-cleaning-copilot-main`. |
...
- **Commits listed:** The lineage section lists every commit that modified the service path (`data-cleaning-copilot-main`), as produced by:
  ```bash
  git log --follow -- data-cleaning-copilot-main
  ```
