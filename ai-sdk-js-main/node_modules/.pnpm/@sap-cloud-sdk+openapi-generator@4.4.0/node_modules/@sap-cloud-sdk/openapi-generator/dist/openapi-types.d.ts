 ...
 * @internal
 */
export interface OpenApiOperation extends Omit<OpenAPIV3.OperationObject, 'requestBody'> {
    /**
 ...
 * @internal
 */
export interface OpenApiParameter extends Omit<OpenAPIV3.ParameterObject, 'schema'>, OpenApiNamedSchema {
    /**
 ...
 * @internal
 */
export type OpenApiSchema = OpenApiReferenceSchema | OpenApiArraySchema | OpenApiSimpleSchema | OpenApiObjectSchema | OpenApiEnumSchema | OpenApiOneOfSchema | OpenApiAllOfSchema | OpenApiAnyOfSchema | OpenApiNotSchema;
/**
 ...
 * @internal
 */
export type OpenApiDiscriminator = Omit<OpenAPIV3.DiscriminatorObject, 'mapping'> & {
