 ...
 * @internal
 */
export declare const defaultApiName = "default";
/**
 * Key for the API name extension.
 * @internal
 */
export declare const apiNameExtension = "x-sap-cloud-sdk-api-name";
/**
 * Key for the operation name extension.
 * @internal
 */
export declare const operationNameExtension = "x-sap-cloud-sdk-operation-name";
/**
