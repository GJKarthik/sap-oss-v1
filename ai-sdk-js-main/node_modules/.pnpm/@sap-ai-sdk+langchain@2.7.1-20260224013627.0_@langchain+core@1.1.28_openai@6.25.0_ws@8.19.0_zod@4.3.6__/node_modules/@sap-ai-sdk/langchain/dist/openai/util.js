 ...
 * @internal
 */
export function mapToolToOpenAiFunction(tool, strict) {
 ...
 * @internal
 */
export function mapToolToOpenAiTool(tool, strict) {
    return {
        type: 'function',
 ...
 */
function mapLangChainToolCallToAzureOpenAiToolCall(toolCalls) {
    if (toolCalls) {
        return toolCalls.map(toolCall => ({
...
function mapAiMessageToAzureOpenAiAssistantMessage(message) {
    const tool_calls = mapLangChainToolCallToAzureOpenAiToolCall(message.tool_calls) ??
...
function mapHumanMessageToAzureOpenAiUserMessage(message) {
    return {
        role: 'user',
        content: message.content,
        name: message.name
...
function mapToolMessageToAzureOpenAiToolMessage(message) {
    return {
        role: 'tool',
        content: message.content,
...
function mapFunctionMessageToAzureOpenAiFunctionMessage(message) {
    return {
        role: 'function',
        content: message.content,
