...
standard_safety_control("query-filtering").
...
governance_dimension("langchain-hana", "accountability").
governance_dimension("langchain-hana", "transparency").
governance_dimension("langchain-hana", "data-protection").
