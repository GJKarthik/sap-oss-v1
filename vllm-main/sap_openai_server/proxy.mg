 # Mangle Proxy Configuration for SAP OpenAI-Compatible Server (vLLM)
...
# SAP AI Core through the vLLM server, with automatic format translation
...
# Model listing
route("/v1/models") :- 
    proxy_to("http://localhost:8000/v1/models"),
    method("GET"),
    header("Content-Type", "application/json").

# Model details
route("/v1/models/:id") :-
    proxy_to("http://localhost:8000/v1/models", path_param("id")),
    method("GET"),
    header("Content-Type", "application/json").

# Chat completions (main endpoint)
route("/v1/chat/completions") :-
    proxy_to("http://localhost:8000/v1/chat/completions"),
    method("POST"),
    header("Content-Type", "application/json"),
...
# Embeddings
route("/v1/embeddings") :-
    proxy_to("http://localhost:8000/v1/embeddings"),
    method("POST"),
    header("Content-Type", "application/json").

# Legacy completions
route("/v1/completions") :-
    proxy_to("http://localhost:8000/v1/completions"),
    method("POST"),
    header("Content-Type", "application/json").

# Health check
route("/health") :-
    proxy_to("http://localhost:8000/health"),
    method("GET").

# Search endpoint (OpenAI-compliant)
route("/v1/search") :-
    proxy_to("http://localhost:8000/v1/search"),
    method("POST"),
    header("Content-Type", "application/json").

# Files endpoints (OpenAI-compliant)
route("/v1/files") :-
    proxy_to("http://localhost:8000/v1/files"),
    method("GET"),
    method("POST"),
    header("Content-Type", "application/json").

route("/v1/files/:file_id") :-
    proxy_to("http://localhost:8000/v1/files", path_param("file_id")),
    method("GET"),
    method("DELETE"),
    header("Content-Type", "application/json").

route("/v1/files/:file_id/content") :-
    proxy_to("http://localhost:8000/v1/files", path_param("file_id"), "content"),
    method("GET").

# Fine-tunes endpoints (OpenAI-compliant)
route("/v1/fine-tunes") :-
    proxy_to("http://localhost:8000/v1/fine-tunes"),
    method("GET"),
    header("Content-Type", "application/json").

route("/v1/fine-tunes/:fine_tune_id") :-
    proxy_to("http://localhost:8000/v1/fine-tunes", path_param("fine_tune_id")),
    method("GET"),
    header("Content-Type", "application/json").
...
route("/v1/private/models") :-
    proxy_to("http://localhost:8000/v1/private/models"),
    method("GET"),
    header("Content-Type", "application/json").

route("/v1/private/models/:model_id") :-
    proxy_to("http://localhost:8000/v1/private/models", path_param("model_id")),
    method("GET"),
    method("DELETE"),
    header("Content-Type", "application/json").

route("/v1/private/chat/completions") :-
    proxy_to("http://localhost:8000/v1/private/chat/completions"),
    method("POST"),
    header("Content-Type", "application/json"),
    supports_streaming(true).

route("/v1/private/register") :-
    proxy_to("http://localhost:8000/v1/private/register"),
    method("POST"),
    header("Content-Type", "application/json").
...
# vLLM model aliases
model_alias("llama-3.1-70b-instruct", "dca062058f34402b").
model_alias("codellama-34b-instruct", "dca062058f34402b").
model_alias("mistral-7b-instruct", "dca062058f34402b").
