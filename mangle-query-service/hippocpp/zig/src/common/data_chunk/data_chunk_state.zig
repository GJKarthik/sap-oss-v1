//! common/data_chunk/data_chunk_state parity module.
...
pub fn modulePath() []const u8 {
    return "common/data_chunk/data_chunk_state";
}

test "data_chunk_state module path" {
    try std.testing.expectEqualStrings("common/data_chunk/data_chunk_state", modulePath());
}

test "data_chunk_state resolved tag fallback" {
    var node = ParityNode.init("");
    try std.testing.expect(node.tagMatches("common/data_chunk/data_chunk_state"));
}
