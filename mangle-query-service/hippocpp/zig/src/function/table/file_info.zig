//! function/table/file_info parity module.
...
pub fn modulePath() []const u8 {
    return "function/table/file_info";
}

test "file_info module path" {
    try std.testing.expectEqualStrings("function/table/file_info", modulePath());
}

test "file_info canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/table/file_info"));
}
