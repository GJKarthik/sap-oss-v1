//! function/arithmetic/set_seed parity module.
...
pub fn modulePath() []const u8 {
    return "function/arithmetic/set_seed";
}

test "set_seed module path" {
    try std.testing.expectEqualStrings("function/arithmetic/set_seed", modulePath());
}

test "set_seed canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/arithmetic/set_seed"));
}
