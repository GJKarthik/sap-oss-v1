//! function/utility/nullif parity module.
...
pub fn modulePath() []const u8 {
    return "function/utility/nullif";
}

test "nullif module path" {
    try std.testing.expectEqualStrings("function/utility/nullif", modulePath());
}

test "nullif canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/utility/nullif"));
}
