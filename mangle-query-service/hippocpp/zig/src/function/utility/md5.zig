//! function/utility/md5 parity module.
...
pub fn modulePath() []const u8 {
    return "function/utility/md5";
}

test "md5 module path" {
    try std.testing.expectEqualStrings("function/utility/md5", modulePath());
}

test "md5 canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/utility/md5"));
}
