//! function/utility/sha256 parity module.
...
pub fn modulePath() []const u8 {
    return "function/utility/sha256";
}

test "sha256 module path" {
    try std.testing.expectEqualStrings("function/utility/sha256", modulePath());
}

test "sha256 canonical name fallback" {
    var module = Module.init("");
    try std.testing.expect(module.matches("function/utility/sha256"));
}
